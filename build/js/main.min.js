...
/* harmony import */ var _modules_menu_toggle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/menu-toggle.js */ "./js/modules/menu-toggle.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_menu_toggle_js__WEBPACK_IMPORTED_MODULE_2__["menuToggle"])();
  });
});
...
var initMenu = function initMenu() {
  var menu = document.querySelector('[data-header-nav]');
...
var menuToggleHandler = function menuToggleHandler(iconOpen, iconClose, navMenu) {
  iconOpen.classList.toggle('is-active');
  iconClose.classList.toggle('is-active');
  navMenu.classList.toggle('is-open');
};
var menuToggle = function menuToggle() {
  var btnToggle = document.querySelector('[data-btn-toggle]');
  var iconOpen = btnToggle.querySelector('[data-icon-open]');
  var iconClose = btnToggle.querySelector('[data-icon-close]');
  var navMenu = document.querySelector('[data-header-nav]');
  if (btnToggle) {
